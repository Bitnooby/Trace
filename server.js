...
app.get('/sitemap.xml', async (req, res) => {
  const base = `${req.protocol}://${req.get('host')}`;
  const pages = ['/', '/feed', '/radar', '/onrecord', '/trending', '/faq', '/terms', '/why-ai-video-detectors-fail', '/developers', '/privacy'];
  let reports = [];
