...
module.exports = function telegram({ claims, ai, img, video, news, redisOn, redisCmd } = {}) {
  ...
  async function handle(update) {
    try {
      ...
      if (/^\/share\b/.test(text)) { await send(chatId, '📣 <b>Share Relity</b>\n\nForward this to a friend or drop it in a group:\n\n<b>Is it real? 🔎</b>\n@RelityCheck_bot shows the <i>evidence</i> behind anything:\n\n• Send a <b>claim, post, image, or video</b> → sourced, debunked, opinion, or AI-generated\n• In a group, reply <b>/check</b> to fact-check what someone shared\n• <b>/subscribe</b> — a daily digest of what independent newsrooms actually agree on\n\nEvidence, not verdicts — you decide.\n👉 https://t.me/RelityCheck_bot   ·   relity.ai'); return; }
